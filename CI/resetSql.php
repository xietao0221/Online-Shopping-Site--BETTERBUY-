...
$sql = "INSERT INTO sales".
    ...
    "VALUES ".
    "('W002', 'Piccolo', '7000', 0.9, 6300, '2015-07-01', '2017-08-25')," .
    "('W003', 'Oboe', '10000', 0.95, 9500, '2015-07-01', '2017-08-25')," .
    "('B001', 'Horn', '8000', 0.8, 6400, '2015-07-01', '2017-08-25')," .
    "('B003', 'Trombone', '4000', 0.85, 3400, '2015-07-01', '2017-08-25')," .
    "('P001', 'Snare Drum', '2000', 0.95, 1900, '2015-07-01', '2017-08-25')," .
    "('K001', 'Piano', '10000', 0.7, 7000, '2015-07-01', '2017-08-25')," .
    "('S003', 'Cello', '5000', 0.8, 4000, '2015-07-01', '2017-08-25');";
$res = mysql_query($sql, $con);
if(!$res) {
    die ('Cannot enter data into TABLE "product": ' . mysql_error());
}
